...
export { SemanticQualityGuard } from "./semantic-quality.js";
...
import { SemanticQualityGuard } from "./semantic-quality.js";
import type { Guard } from "../core/types.js";

export const semanticQualityGuard = new SemanticQualityGuard();
